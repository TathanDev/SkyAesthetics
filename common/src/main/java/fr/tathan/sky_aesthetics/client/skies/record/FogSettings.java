...
public record FogSettings(Boolean fog, Optional<Vector4f> customFogColor, Optional<Vector2f> fogDensity) {
    ...
    public static final Codec<FogSettings> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            SkyColor.VEC4F.optionalFieldOf("fog_color").forGetter(FogSettings::customFogColor),
