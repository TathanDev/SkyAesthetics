...
public final class CustomVanillaObject {
     ...
     * @param intensity  Multiplier for sun brightness. Default 1.0 (vanilla brightness).
     */
    public record Sun(boolean show, Optional<Identifier> sunTexture, float size, float intensity) {
        ...
        public static final Codec<Sun> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                ...
                Codec.FLOAT.optionalFieldOf("intensity", 1.0f).forGetter(Sun::intensity)
     ...
     * @param intensity   Multiplier for moon brightness. Default 1.0 (vanilla brightness).
     */
    public record Moon(boolean show, Optional<Identifier> moonTexture, float size, boolean showPhases, float intensity) {
        ...
        public static final Codec<Moon> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                ...
                Codec.FLOAT.optionalFieldOf("intensity", 1.0f).forGetter(Moon::intensity)
