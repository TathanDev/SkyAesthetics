...
public record Constellation(
         String id, float scale, Vec3 color, Vec3 firstPoint, List<Vec3> points, Optional<Identifier> starTexture) {
    ...
    public static final Codec<Constellation> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.optionalFieldOf("star_texture").forGetter(Constellation::starTexture)
