...
public class SkyRenderer {
    ...
    public void render(ClientLevel level, PoseStack poseStack, Matrix4f projectionMatrix, float partialTick, Camera camera, Runnable fogCallback) {
        ...
        ModelUtils.drawCelestialCube(new SkyObject(ResourceLocation.parse("sky_aesthetics:textures/mars2.png"), false, 10,  new Vec3(0, 0, 0), Optional.of(new Vector3f(-10, 20, 20)) , 100, "DAY"), poseStack, dayAngle);
